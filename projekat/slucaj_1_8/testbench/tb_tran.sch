...
S {}
E {}
T {Transient testbench
Wp = 1.8 * Wn} 280 -630 0 0 0.4 0.4 {}
N 290 -500 520 -500 {
lab=a}
N 290 -500 290 -480 {
lab=a}
...
N 650 -580 650 -530 {
lab=#net1}
C {vsource.sym} 290 -450 0 0 {name=Va value="PULSE(0 1.5 0 0.1p 0.1p 100p 200p)" savecurrent=false}
...
.control
  ...
  print tr_out tf_out
  wrdata /home/Nikola.Jankovic/projekat/slucaj_1_8/python/odziv_1_8.txt v(a) v(out)
.endc"
}
C {/home/Nikola.Jankovic/projekat/slucaj_1_8/schematic/funkcija.sym} 670 -470 0 0 {name=x1}
