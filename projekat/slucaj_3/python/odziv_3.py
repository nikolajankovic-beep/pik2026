...
podaci = np.loadtxt('/home/Nikola.Jankovic/projekat/slucaj_3/python/odziv_3.txt') 
...
ax.set_title('Tranzijentna analiza: Vremena rasta i pada (Odnos $W_p / W_n = 3$)', fontsize=14, fontweight='bold', pad=15)
...
plt.tight_layout()
plt.savefig('/home/Nikola.Jankovic/projekat/slucaj_3/python/odziv_3.svg', format='svg', bbox_inches='tight')
plt.show()
