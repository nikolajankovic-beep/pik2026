...
N 690 -410 710 -410 {
lab=GND}
C {vsource.sym} 290 -450 0 0 {name=Va value=1.5 savecurrent=false}
C {vsource.sym} 350 -430 0 0 {name=Vb value=1.5 savecurrent=false}
C {vsource.sym} 410 -410 0 0 {name=Vc value=1.5 savecurrent=false}
C {vsource.sym} 480 -390 0 0 {name=Vd value="PULSE(0 1.5 0 0.1p 0.1p 100p 200p)" savecurrent=false}
...
C {gnd.sym} 710 -400 0 0 {name=l7 lab=GND}
...
C {/home/Nikola.Jankovic/projekat/slucaj_3/sema.sym} 670 -470 0 0 {name=x1}
C {devices/code.sym} 100 -490 0 0 {name=NGSPICE only_toplevel=false value="
...
.control
  ...
  plot v(a)+6 v(b)+4.5 v(c)+3 v(d)+1.5 v(out)
  print tr_out tf_out
.endc"
}
