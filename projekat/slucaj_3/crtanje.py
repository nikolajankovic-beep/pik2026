...
podaci = np.loadtxt('najgori_odziv_3.txt') 
...
# 5. Ulepšavanje
ax.set_title('Tranzijentni odziv: Vremena rasta i pada (Odnos $W_p / W_n = 3$)', fontsize=14, fontweight='bold', pad=15)
...
# 6. Čuvanje
plt.tight_layout()
plt.savefig('odziv_3.png', dpi=300, bbox_inches='tight')
plt.show()
