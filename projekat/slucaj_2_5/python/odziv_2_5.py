...
podaci = np.loadtxt('/home/Nikola.Jankovic/projekat/slucaj_2_5/python/odziv_2_5.txt') 
...
ax.set_title('Tranzijentna analiza: Vremena rasta i pada (Odnos $W_p / W_n = 2.5$)', fontsize=14, fontweight='bold', pad=15)
...
plt.tight_layout()
plt.savefig('/home/Nikola.Jankovic/projekat/slucaj_2_5/python/odziv_2_5.svg', format='svg', bbox_inches='tight')
plt.show()
