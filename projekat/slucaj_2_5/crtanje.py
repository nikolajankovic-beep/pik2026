...
podaci = np.loadtxt('najgori_odziv_2_5.txt') 
...
# 5. Ulepšavanje
ax.set_title('Tranzijentni odziv: Vremena rasta i pada (Odnos $W_p / W_n = 2.5$)', fontsize=14, fontweight='bold', pad=15)
...
# 6. Čuvanje
plt.tight_layout()
plt.savefig('odziv_2_5.png', dpi=300, bbox_inches='tight')
plt.show()
