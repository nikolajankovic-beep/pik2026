...
C {devices/code.sym} 90 -490 0 0 {name=NGSPICE only_toplevel=false value="
...
.control
  ...
  wrdata /home/Nikola.Jankovic/projekat/slucaj_2_5/python/odziv_2_5.txt v(a) v(out)
  print tr_out tf_out
.endc"
}
C {/home/Nikola.Jankovic/projekat/slucaj_2_5/schematic/funkcija.sym} 670 -470 0 0 {name=x1}
