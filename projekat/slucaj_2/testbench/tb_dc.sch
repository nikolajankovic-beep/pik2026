...
Non matching
DC analysis} 190 -670 0 0 0.4 0.4 {}
N 290 -500 520 -500 {
lab=a}
N 290 -500 290 -480 {
lab=a}
...
N 680 -410 690 -410 {
lab=GND}
C {vsource.sym} 290 -450 0 0 {name=Va value=0 savecurrent=false}
...
.control
  ...
  * Crtanje izvoda VTC krive za pronalazenje margina suma (trazi se gde je y = -1)
  *plot deriv(v(out)) vs v(a)
  
   wrdata /home/Nikola.Jankovic/projekat/slucaj_2/python/vtc_kriva.txt v(out)
.endc"}
