...
podaci = np.loadtxt('/home/Nikola.Jankovic/projekat/slucaj_2/pex/python/odziv_nonmatch.txt') 
...
ax.set_title('Tranzijentna analiza: Vremena rasta i pada (Odnos $W_p / W_n = 2$)\n Postlayout-PEX  without matching', fontsize=14, fontweight='bold', pad=15)
...
plt.tight_layout()
plt.savefig('/home/Nikola.Jankovic/projekat/slucaj_2/pex/python/odziv_nonmatch.svg', format='svg', bbox_inches='tight')
plt.show()
