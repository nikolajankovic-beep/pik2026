...
podaci = np.loadtxt('/home/Nikola.Jankovic/projekat/slucaj_2/pex/python/odziv_match.txt') 
...
plt.tight_layout()
plt.savefig('/home/Nikola.Jankovic/projekat/slucaj_2/pex/python/odziv_match.svg', format='svg', bbox_inches='tight')
plt.show()
