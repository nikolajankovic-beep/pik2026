...
Non matching} 190 -670 0 0 0.4 0.4 {}
N 290 -500 520 -500 {
lab=a}
N 290 -500 290 -480 {
lab=a}
...
.include /home/Nikola.Jankovic/projekat/slucaj_2/pex/layout/funkcija.spice
.tran 0.1p 800p
...
.control
  ...
  wrdata /home/Nikola.Jankovic/projekat/slucaj_2/pex/python/odziv_nonmatch.txt v(a) v(out)
  print tr_out tf_out
.endc"
}
C {lab_pin.sym} 820 -480 1 0 {name=p6 sig_type=std_logic lab=out}
C {lab_pin.sym} 650 -550 2 0 {name=p7 sig_type=std_logic lab=vdd}
C {/home/Nikola.Jankovic/projekat/slucaj_2/pex/schematic/funkcija.sym} 670 -470 0 0 {name=x1}
